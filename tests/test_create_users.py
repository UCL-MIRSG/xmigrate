...
@pytest.mark.parametrize("xnatpy_connections", [
    (
        [
...
@pytest.mark.parametrize("xnatpy_connections", [
    (
        [
            {"username": "example1@fake.com", "id": 1, "enabled": True,
             "email": "example1@fake.com", "verified": True,
             "firstName": "fake", "lastName": "street"},
            {"username": "example2@fake.com", "id": 2, "enabled": True,
             "email": "example2@fake.com", "verified": True,
             "firstName": "fake", "lastName": "street"},
            {"username": "example3@fake.com", "id": 3, "enabled": True,
             "email": "example3@fake.com", "verified": True,
             "firstName": "fake", "lastName": "street"},
        ],
        [
            {"username": "example1@fake.com", "id": 1, "enabled": True,
